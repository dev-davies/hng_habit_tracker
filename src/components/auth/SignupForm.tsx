    ...
    <div className="w-full max-w-sm mx-auto p-6 sm:p-8 bg-white dark:bg-stone-900 rounded-3xl border border-stone-200 dark:border-stone-800 shadow-[4px_4px_0px_0px_rgba(249,115,22,0.2)] dark:shadow-[4px_4px_0px_0px_rgba(249,115,22,0.1)] transition-all">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        <div className="flex flex-col gap-2">
          <label htmlFor="signup-email" className="text-sm font-semibold text-stone-700 dark:text-stone-300 ml-1">
            Email Address
          </label>
          <input
            id="signup-email"
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="signup-password" className="text-sm font-semibold text-stone-700 dark:text-stone-300 ml-1">
            Password
          </label>
          <input
            id="signup-password"
